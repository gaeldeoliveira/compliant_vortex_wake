classdef constant_strenght_vortex_segment_axi < handle
    ...
    methods
        function VS = constant_strenght_vortex_segment_axi(x_start, y_start, x_end, y_end, gamma)
        ...
        function [pot , u , v] = induced_speed_on_single_point(VS, x, y)
            ...
            % Include contribution of IPC case, if applicable
            %if not(isempty(VS.ipc))
            %    % Compute contribution
            %    [u_v, v_v] = ipc.induced_speed_on_many_points(x, y);
            %    % Add it
            %    u   = u   + u_v;
            %    v   = v   + v_v;
            %end
        ...
        function [pot , u , v] = induced_speed_on_many_points(VS, x, y)
            % Get Induced speed over multiple points
              ...
              for n_segment = 1:VS.n_segments
                  [pot_t , u_t , v_t] = ...
                    induction_functions_axi.constant_strenght_vortex_segment_element(x , y, ...
