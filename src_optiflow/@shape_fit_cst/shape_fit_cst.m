...
%       parameters_suction
    ...
    methods
        ...
        function [x, imported_coordinates, regenerated_coordinates, parameters]= get_parameters_from_file(SF , fileToRead)
            ...
            imported_coordinates    = SF.imported_coordinates;
            regenerated_coordinates = SF.imported_coordinates;
