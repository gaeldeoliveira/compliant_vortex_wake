...
y_duct       =  0.68;           % Translation of airfoil rotation point from origin (y direction)
...
flip_airfoil = true;            % Flip airfoil upside down
...
flip_airfoil2  = true;            % Flip airfoil upside down
