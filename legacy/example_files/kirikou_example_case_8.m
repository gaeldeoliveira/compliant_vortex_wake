...
alpha_duct   =-30*pi()/180;     % Duct Airfoils Geometric Angle of Attack (in radians)
...
if graph_viz == true
    ...
    % Print
    print -dpng -r300 kirikou_example_case_8_velocity_field.png
end
...
print -dpng -r300 kirikou_example_case_8_centerline_speed.png
...
print -dpng -r300 kirikou_example_case_8_induction_breakdown.png
...
print -dpng -r300 kirikou_example_case_8_cp_distribution.png
...
print -dpng -r300 kirikou_example_case_8_wake_shape.png
