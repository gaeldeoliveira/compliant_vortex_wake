...
alpha_duct   =-20*pi()/180;     % Duct Airfoils Geometric Angle of Attack (in radians)
...
if graph_viz == true
    ...
    % Print
    print -dpng -r300 kirikou_example_case_7_velocity_field.png
end
...
print -dpng -r300 kirikou_example_case_7_centerline_speed.png
...
print -dpng -r300 kirikou_example_case_7_induction_breakdown.png
...
print -dpng -r300 kirikou_example_case_7_cp_distribution.png
