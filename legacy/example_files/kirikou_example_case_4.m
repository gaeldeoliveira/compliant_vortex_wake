...
x_duct       = -1.10;           % Translation of airfoil rotation point from origin (x direction)
y_duct       =  0.20;           % Translation of airfoil rotation point from origin (y direction)
alpha_duct   =  0*pi()/180;    % Duct Airfoils Geometric Angle of Attack (in radians)
...
if graph_viz == true
    ...
    % Print
    print -dpng -r300 kirikou_example_case_4_velocity_field.png
end
...
print -dpng -r300 kirikou_example_case_4_centerline_speed.png
...
print -dpng -r300 kirikou_example_case_4_induction_breakdown.png
...
print -dpng -r300 kirikou_example_case_4_cp_distribution.png
...
print -dpng -r300 kirikou_example_case_7_wake_shape.png
