...
y_duct       = 1.0;             % Translation of airfoil rotation point from origin (y direction)
...
if graph_viz == true
    ...
    % Print
    print -dpng -r300 kirikou_example_case_2_velocity_field.png
end
...
print -dpng -r300 kirikou_example_case_2_centerline_speed.png
...
print -dpng -r300 kirikou_example_case_2_induction_breakdown.png
...
print -dpng -r300 kirikou_example_case_2_cp_distribution.png
...
% Bells and Whistles
title('Wake Shape')
legend('Upper Side - with body', 'Lower Side - with body', 'Upper Side - without body', 'Lower Side - without body')
print -dpng -r300 kirikou_example_case_2_wake_shape.png
